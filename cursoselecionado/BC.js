        ...
        <View style={styles.quadrado}>
          <View style={styles.quadrado2}>
            <View style={styles.quadrado3}>
              <View>
                <Image source={require('../cursoselecionado/assets/bootcampinho.jpg')} style={{ width: 320, height: 160, borderRadius: 10, }}></Image>
              </View>
            </View>
            <Text style={styles.titulocurso}>Bootcampinho UI UX | Curso Gratuito no YouTube</Text>
            <Text style={styles.subtitulocurso}>O Bootcampinho Gratuito UI/UX Design tem como objetivo te ajudar nos primeiros passos de sua jornada.</Text>
            <View style={styles.linha1}>
            </View>
            <TouchableOpacity style={styles.button} onPress={() => { Linking.openURL('https://www.youtube.com/playlist?list=PLuDfCQO9tvX0kDmh4cjo30uidCeJ-iZE6') }}>
