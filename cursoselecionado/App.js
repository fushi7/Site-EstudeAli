        ...
        <View style={styles.quadrado}>
          <View style={styles.quadrado2}>
            <View style={styles.quadrado3}>
              <View>
                <Image source={require('../cursoselecionado/assets/py-guanabara1.png')} style={{ width: 180, height: 160, borderRadius: 10, left: 65, }}></Image>
              </View>
            </View>
            <Text style={styles.titulocurso}>Python 3 – Mundo 1 [40 Horas]</Text>
            <Text style={styles.subtitulocurso}>Primeiro mundo do curso introduz a linguagem, seus conceitos e ensina alguns recursos básicos.</Text>
            <View style={styles.linha1}>
            </View>
            <TouchableOpacity style={styles.button} onPress={() => { Linking.openURL('https://www.cursoemvideo.com/curso/python-3-mundo-1/') }}>
