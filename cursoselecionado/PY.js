        ...
        <View style={styles.quadrado}>
          <View style={styles.quadrado2}>
            <View style={styles.quadrado3}>
              <View>
                <Image source={require('../cursoselecionado/assets/py-iniciantes.jpg')} style={{ width: 320, height: 160, borderRadius: 10, }}></Image>
              </View>
            </View>
            <Text style={styles.titulocurso}>Curso Python p/ Iniciantes</Text>
            <Text style={styles.subtitulocurso}>Esse curso ensina tudo o que você precisa saber sobre Python e Fundamentos básicos de programação.</Text>
            <View style={styles.linha1}>
            </View>
            <TouchableOpacity style={styles.button} onPress={() => { Linking.openURL('https://www.youtube.com/playlist?list=PLj7gJIFoP7jdirAFg-fHe9HKOnGLGXSHZ') }}>
